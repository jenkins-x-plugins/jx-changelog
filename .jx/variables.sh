...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-plugins/jx-changelog/main/11'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-changelog:0.7.0'
